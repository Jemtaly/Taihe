...
public:
  ...
  ::ns_alltest::functiontest::ErrorResponse BaseFunctionTest58(bool param1) {
    if (param1) {
      ...
      return {false, static_cast<int16_t>(g_testIntAdd100),
              std::string("test581")};
    }
  }
};
...
public:
  ...
  int8_t BasePerformanceFunctionTest2(int8_t param1) {
    ...
    if (result > INT8_MAX || result < INT8_MIN) {
      taihe::set_error(
          "BasePerformanceFunctionTest2: result exceeds int8_t range");
    }
    // 返回结果
    return static_cast<int8_t>(result);
  }
  ...
  ::ns_alltest::functiontest::TestUnionName getUnion_test_attribute() {
    return ::ns_alltest::functiontest::TestUnionName::make_value1(
        g_testIntAdd100);
  }
...
map<string, int32_t> BaseFunctionTest29(map_view<string, int32_t> param1) {
  ...
  for (std::size_t i = 0; i < param1.size(); ++i) {
    m.emplace("test" + std::to_string(i),
              g_testIntAdd10 + static_cast<int32_t>(i));
  }
  return m;
}
...
array<int32_t> BaseFunctionTest36(int8_t param1, int16_t param2, bool param8,
...
string BaseFunctionTest38(int8_t param1, string_view param7, bool param8,
                          array_view<int8_t> param9,
...
bool BaseFunctionTest39(int16_t param2, string_view param7, bool param8,
...
array<int8_t> BaseFunctionTest40(double param6, string_view param7, bool param8,
                                 array_view<int8_t> param9,
...
::ns_alltest::functiontest::TestInterfacePerformance21
get_interface_performance21() {
  return make_holder<TestInterfacePerformance21,
                     ::ns_alltest::functiontest::TestInterfacePerformance21>();
}

::ns_alltest::functiontest::IbaseInterface2 get_interface_IbaseInterface2() {
  return make_holder<IbaseInterface2,
                     ::ns_alltest::functiontest::IbaseInterface2>();
}

::ns_alltest::functiontest::IbaseInterface3 get_interface_IbaseInterface3() {
  return make_holder<IbaseInterface3,
                     ::ns_alltest::functiontest::IbaseInterface3>();
}
