...
inline PixelMapFormat::key_t toPixelMapFormatKey(OHOS::Media::PixelFormat format)
{
...
public:
    ...
    ImageSourceImpl(string_view str)
    {
        ...
        uint32_t errorCode;
        this->m_pdata = OHOS::Media::ImageSource::CreateImageSource(this->filePath_, opts, errorCode);
    ...
    ImageSourceImpl(int32_t fd)
    {
        OHOS::Media::SourceOptions opts;
        uint32_t errorCode;
        this->m_pdata = OHOS::Media::ImageSource::CreateImageSource(fd, opts, errorCode);
        this->fileDescriptor_ = 0;  // TODO
    }
