...
namespace {
ColorSpacePrimaries SRGB_PRIMARIES = {0.64, 0.33, 0.30,   0.60,
                                      0.15, 0.06, 0.3127, 0.3290};

ColorSpacePrimaries DISPLAY_P3_PRIMARIES = {0.68, 0.32, 0.265,  0.69,
                                            0.15, 0.06, 0.3127, 0.3290};

class ColorSpaceManagerImpl {
public:
  ColorSpaceManagerImpl(ColorSpace space, ColorSpacePrimaries const &primaries,
                        double gamma)
