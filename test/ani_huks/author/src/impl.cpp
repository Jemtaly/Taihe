...
::huks::HuksResult generateKey(string_view keyAlias,
    ...
    huks::HuksParam huksParam = {
        ...
        .value = huks::HuksParamValue::make_bufferValue(
            array<uint8_t>::make(4, 0xcc)),
    };
    huks::HuksResult huksResult = {
        .errorCode = 0.0,
        .outData =
            optional<array<uint8_t>>::make(array<uint8_t>::make(3, 0x12)),
