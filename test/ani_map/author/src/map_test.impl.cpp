...
map<string, array<int8_t>> Mapfunc34()
{
    ...
    result.insert("key1", a);
    result.insert("key2", b);
    return result;
}
...
map<string, map_test::Pair> Mapfunc43()
{
    ...
    result.insert("key1", p1);
    result.insert("key2", p2);
    return result;
}
...
map<string, uintptr_t> Mapfunc46()
{
    ...
    result.insert("key1", reinterpret_cast<uintptr_t>(nullptr));
    result.insert("key2", reinterpret_cast<uintptr_t>(nullptr));
    return result;
}
...
map<string, map<string, bool>> Mapfunc47()
{
    ...
    bool const value1 = true;
    bool const value2 = false;
    m1.insert("subkey1", value1);
    m1.insert("subkey2", value2);
    result.insert("key1", m1);
    map<string, bool> m2;
    bool const value3 = true;
    bool const value4 = false;
    m2.insert("subkey3", value3);
    m2.insert("subkey4", value4);
    result.insert("key2", m2);
    return result;
}
