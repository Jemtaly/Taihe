...
struct AuthorIBase {
    ...
    AuthorIBase(taihe::core::string_view name, taihe::core::string_view t)
        : name(t) {}
    ~AuthorIBase() {}
...
::staticTest::IBase getIBase_test_impl(taihe::core::string_view name,
                                       taihe::core::string_view t) {
