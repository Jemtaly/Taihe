...
int main() {
...

    {
        ...
        IShowable colored_rect =
            makeColoredRectangle("Rect", color_yellow, 5, 5);
        ...
        // `impl_holder<Impl, Iface...>` can call methods of Impl itself that
...

    {
        ...
        auto tmp = currying(
            callback<string(string_view, string_view)>::from<MyCallback>("f"))(
            "abc");
        auto res = tmp("123");
