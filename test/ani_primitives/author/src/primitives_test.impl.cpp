...
public:
    void testBaseFunc1() { std::cout << "testBaseFunc1 is true " << std::endl; }
    ...
    void testBaseFunc12(optional_view<int32_t> option1,
    ...
    void testBaseFunc13(optional_view<float> option1,
                        optional_view<double> option2) {
        if (option1) {
            std::cout << *option1 << std::endl;
        } else if (option2) {
            std::cout << *option2 << std::endl;
    ...
    void testBaseFunc14(optional_view<string> option1,
                        optional_view<bool> option2) {
        if (option1) {
            std::cout << *option1 << std::endl;
        } else if (option2) {
            std::cout << *option2 << std::endl;
    ...
    void testBaseFunc15(optional_view<int16_t> option1,
                        optional_view<int64_t> option2) {
        if (option1) {
            std::cout << *option1 << std::endl;
        } else if (option2) {
    ...
    void testBaseFunc17(array_view<int32_t> option1,
                        array_view<int8_t> option2) {
        // 输出 option1 的内容
    ...
    void testBaseFunc18(array_view<int16_t> option1,
                        array_view<int64_t> option2) {
        // 输出 option1 的内容
    ...
    void testBaseFunc19(array_view<float> option1, array_view<double> option2) {
        ...
        // std::cout << std::fixed << std::setprecision(6); // float 保留 6
        // 位小数
...
public:
    int8_t testBaseIntegerFunc1(int8_t option1) {
        if (option1 == -1) {
            taihe::core::set_error(
                "out of range The i8 maximum value is 127 and minnum values is "
                "-128");
            return -1;
        }
        return option1 + 1;
    ...
    int8_t testBaseIntegerFunc2(int8_t option1, int16_t option2) {
        ...
        if (option2 == -1) {
            taihe::core::set_error(
                "out of range The i16 maximum value is 32767 and minnum values "
                "is "
                "-32768");
            return -1;
        }
    ...
    void testBaseIntegerFunc3(int8_t option1, int16_t option2) {
        std::cout << "testBaseIntegerFunc3 is option1  " << (int)option1
                  << std::endl;
        std::cout << "testBaseIntegerFunc3 is option2  " << option2
                  << std::endl;
    }
    ...
    void testBaseIntegerFunc7(int8_t option1, int32_t option2) {
        if (option2 == -1) {
            taihe::core::set_error(
                "out of range The i32 maximum value is 2147483647 and minnum "
                "values "
                "is -2147483648");
        }
        std::cout << "testBaseIntegerFunc7 is option1  " << (int)option1
                  << std::endl;
        std::cout << "testBaseIntegerFunc7 is option2  " << option2
                  << std::endl;
    }
    ...
    void testBaseIntegerFunc19(int16_t option1) {
        std::cout << "testBaseIntegerFunc19 is option1  " << option1
                  << std::endl;
    }
    ...
    void testBaseIntegerFunc23(int32_t option1) {
        ...
        std::cout << "testBaseIntegerFunc23 is option1  " << option1
                  << std::endl;
    }
    ...
    void testBaseIntegerFunc27(int64_t option1) {
        std::cout << "testBaseIntegerFunc27 is option1  " << option1
                  << std::endl;
    }
    ...
    float testBaseIntegerFunc30(float option1) { return option1 + 1.0; }
    void testBaseIntegerFunc31(float option1) {
        std::cout << std::fixed << std::setprecision(6);  // float 保留 6 位小数
        std::cout << "testBaseIntegerFunc31 is option1  " << option1
                  << std::endl;
    }
    ...
    double testBaseIntegerFunc34(double option1) { return option1 + 1; }
    void testBaseIntegerFunc35(double option1) {
        std::cout << std::fixed
                  << std::setprecision(15);  // float 保留 6 位小数
        std::cout << "testBaseIntegerFunc35 is option1  " << option1
                  << std::endl;
    }
};
...
string baseFunc8(string_view a, int32_t b) {
    if (a == "testbaseFunc8") {
        return std::string(a)
               + std::to_string(b);  // 返回 a + b（b 转换为字符串）
    } else {
        return std::string(a);  // 返回 a
    }
}
...
void baseFunc21(optional_view<int32_t> option1,
                optional_view<int64_t> option2) {
    if (option1) {
        std::cout << *option1 << std::endl;
    } else if (option2) {
...
void baseFunc24(optional_view<int16_t> option1,
                optional_view<int64_t> option2) {
    if (option1) {
        std::cout << *option1 << std::endl;
    } else if (option2) {
...
::primitives_test::primitivesBoolean get_interface_bool() {
    return make_holder<primitivesBoolean,
                       ::primitives_test::primitivesBoolean>();
}
::primitives_test::primitivesInteger get_interface_interger() {
    return make_holder<primitivesInteger,
                       ::primitives_test::primitivesInteger>();
}
