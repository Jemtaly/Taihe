...
attrVals
    : LEFT_PARENTHESIS (AttrValLst_items += attrVal (COMMA AttrValLst_items += attrVal)*)? RIGHT_PARENTHESIS
    ;
...
type
    : token_name = (KW_I8 | KW_I16 | KW_I32 | KW_I64 | KW_U8 | KW_U16 | KW_U32 | KW_U64 | KW_F32 | KW_F64 | KW_BOOL | KW_STRING | KW_CPOINTER) # primitiveType
